...
class EmployesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employe" do
    assert_difference('Employe.count') do
      post employes_url, params: { employe: { lastName: @employe.lastName, name: @employe.name } }
    end
  ...
  test "should update employe" do
    patch employe_url(@employe), params: { employe: { lastName: @employe.lastName, name: @employe.name } }
